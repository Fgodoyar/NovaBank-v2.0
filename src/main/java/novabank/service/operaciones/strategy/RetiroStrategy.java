...
public class RetiroStrategy implements OperacionFinanciera {
    private final CuentaRepository cuentaRepository;
    private final MovimientoRepository movimientoRepository;

    public RetiroStrategy(CuentaRepository cuentaRepository, MovimientoRepository movimientoRepository) {
